  ...
  return (
    <>
      ...
      <div className="bg-[#f6f9fb]">
        ...
        {/* use data page */}
        <div className="bg-[#f6f9fb] min-h-screen  px-[12px] pt-[90px] pb-4 flex flex-col items-center relative justify-center w-full ">
          <div className="bg-white w-full  lg:w-[700px] border-10 pt-[50px] px-[70px] pb-[60px] rounded-10  shadow-lg relative m-auto ">
